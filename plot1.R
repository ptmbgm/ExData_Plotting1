...
##This code assumes data has been downloaded and code is executed 
##in directory containing the file 'household_power_consumption.txt'
...
##First plot should be a histogram of Global_active_power
...
plot1.png<- dev.copy(png, width =480, height = 480, units="px")
